...
export class HttpController {
  ...
  async setLabyrinthStartPoint(
    ...
    return this.commandService.setLabyrinthStartPoint(
      id,
      Number(x),
      Number(y),
      req.userId,
  ...
  async setLabyrinthEndPoint(
    ...
    return this.commandService.setLabyrinthEndPoint(
      id,
      Number(x),
      Number(y),
      req.userId,
  ...
  async setLabyrinthPlayfieldPoint(
    ...
    @Param('x') x: string,
    @Param('y') y: string,
    @Param('type') type: LabyrinthFulfillmentType,
  ): Promise<any> {
    return this.commandService.setLabyrinthPlayfieldPoint(
      id,
      Number(x),
      Number(y),
      Number(type),
